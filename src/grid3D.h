...
class Grid3D
{
  ...
  Real Get_Temperature( Real U, Real dens, Real HI_dens, Real HII_dens, Real HeI_dens, Real HeII_dens, Real HeIII_dens  );
  Real Get_Average_Temperature();
  void Set_Reionization_Temperature();
  #endif
